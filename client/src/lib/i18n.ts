  ...
  zh: {
    ...
    howToUse: {
      ...
      steps: [
        {
          title: "互動式情境學習",
          description: "透過角色扮演與情境選擇，讓學習者主導對話發展，提升學習趣味與參與感。"
        },
        {
          title: "動態文法與口語演練",
          description: "結合動態圖像解析文法概念，並搭配即時口語練習，加深記憶與應用能力。"
        },
        {
          title: "多元感官訓練",
          description: "超越傳統紙本限制，整合聽、說、讀的全方位練習，提供更豐富的沈浸式學習體驗。"
        },
        {
          title: "客製化學習輔助",
          description: "提供拼音標註與即時翻譯功能，學習者可依需求自由切換顯示，打造最適合自己的學習模式。"
        }
      ],
      tip: "小提示",
